...
\end{lstlisting}
\captionof{code}{\label{code:platform_driver}Struktur in \cite[linux/platform\_driver.h]{linuxsourceinclude}}
...
\end{lstlisting}
\captionof{code}{\label{code:mfd}Funktionsdeklaration in \cite[mfd/core.h]{linuxsourceinclude}}
