...
\end{lstlisting}
\captionof{code}{Funktionsdeklaration des \ac{ioctl} in der file\_operations Struktur \cite[linux/fs.h, Zeile 1800]{linuxsourceinclude}}
\end{lstfloat}
...
\end{lstlisting}
\captionof{code}{Vereinfachte Funktionsdeklaration aus \cite[linux/uaccess.h, Zeile 140ff.]{linuxsourceinclude}}
\end{lstfloat}
...
\end{lstlisting}
\captionof{code}{\label{code:platform_driver}platform\_driver Struktur in \cite[linux/platform\_device.h, Zeile 184ff.]{linuxsourceinclude}}
\end{lstfloat}
...
%todo warum, siehe embeddedlinux seite 244
