...
\end{lstlisting}
\captionof{lstlisting}{Funktionsdeklaration des \ac{ioctl} in der file\_operations Struktur}
...
\end{lstlisting}
\captionof{lstlisting}{Funktionsdeklaration in asm/uaccess.h}
...
\end{lstlisting}
\captionof{lstlisting}{\label{code:platform_driver}Struktur in linux/platform\_device.h}
...
\end{lstlisting}
\captionof{lstlisting}{Funktionsdeklaration in mfd/core.h}
