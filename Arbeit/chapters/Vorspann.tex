...
This report handles the improvement of an camera software in interaction with the hardware. For this, an abstraction level will be introduce, which should simplify and clearer the accesses from the software to the FPGA.
