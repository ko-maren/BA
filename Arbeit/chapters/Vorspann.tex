...
\begin{figure}
	...
	\begin{subfigure}{.5\textwidth}
		%\centering
		\includegraphics[height=20mm]{pictures/Hochschule_Muenchen_Logo.png}
	\end{subfigure}%
	\begin{subfigure}{.5\textwidth}
		%\centering
		\includegraphics[height=20mm]{pictures/ARRI_AG_Corporate_Logo.png}
	\end{subfigure}
\end{figure}
\end{flushright}
...
lfd. Nr. gem\"a{\ss}  Belegschein: \> %
					  1234 
%% durch richtige lfd Nr ersetzen
\\
\end{tabbing} }
\thispagestyle{empty}
\cleardoublepage
...
\vspace*{10mm}
{\huge \bfseries{%
		\par Modular control of an image processing FPGA via camera software \par
